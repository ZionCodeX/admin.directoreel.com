...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><b>{{ __('C O M P A N Y    R E G I S T R A T I O N') }}</b></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label class="col-3">{{ __('Company Name') }}</label>
                            <div class="col-9">
                                <input type="text" name="last_name" id="last_name" class="form-control @error('last_name') is-invalid @enderror" value="{{ old('last_name') }}" autocomplete="last_name" placeholder="Last Name" autofocus required>
                                @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="form-group row">
                            <label class="col-3">{{ __('Official Website') }}</label>
                            <div class="col-9">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-9">
                              <div class="input-group">
                                ...
                                <input type="company_phone" name="company_phone" id="company_phone" class="form-control @error('company_phone') is-invalid @enderror" value="{{ old('company_phone') }}" autocomplete="company_phone" placeholder="Company Phone Number" autofocus required>
                                    @error('company_phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <a class="btn btn-link" href="{{ route('register_company') }}">
                        <b>&nbsp; Register <small>(Company)</small></b>
                    </a>
