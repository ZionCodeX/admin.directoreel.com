        ...
        <div class="col-md-9">
            ...
            <div class="row pb-26">
                <div class="col-md-3 border-right-md pr-md-10 py-md-10">
                    ...
                    <div class="font-size-lg font-weight-bold mb-10">Atsu Emmanuel
                    <br>No.59 A. Abimbola estate Agege, Lagos, Nigeria.</div>
                    <!--end::Invoice To-->
                    <!--begin::Invoice No-->
                    ...
                    <div class="font-size-lg font-weight-bold">05 June, 2021</div>
                    <!--end::Invoice Date-->
                </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">Unit Cost</th>
                            ...
                            <tbody>
                                ...
                                <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                    ...
                                    </span>Office Chairs (Core 7 Grade)</td>
                                ...
                                <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                    ...
                                    </span>Security Doors (HQ Grade)</td>
    ...
    <div class="row justify-content-center border-top py-8 px-8 py-md-28 px-md-0">
        <div class="col-md-9">
            <div class="d-flex font-size-sm flex-wrap">
                ...
                <button type="button" class="btn btn-secondary font-weight-bolder ml-sm-auto my-1"><a href="{{ route('bank_payment'); }}"><i class="fas fa-building"></i> BANK Payment</a></button>
                <button type="button" class="btn btn-success font-weight-bolder ml-sm-auto my-1"><i class="fas fa-credit-card"></i> CARD Payment</button>
            </div>
        </div>
    </div>
    <!-- end: Invoice action-->
