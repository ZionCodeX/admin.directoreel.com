    ...
    <div class="card-body p-0">
      ...
      <table class="table table-striped table-responsive table-with-responsive">
        ...
        <tbody>
          ...
          <tr>
            <td style="color:gray;"><b>Company Name</b></td>
            <td>{{ $webhr_payroll_config[0]->company_name ?? '' }}</td>
          </tr>
          <tr>
            <td style="color:gray;"><b>Station Name</b></td>
            <td>{{ $webhr_payroll_config[0]->station_name ?? '' }}</td>
          </tr>
          <tr>
            <td style="color:gray;"><b>Division Name</b></td>
            <td>{{ $webhr_payroll_config[0]->division_name ?? '' }}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="color:gray;"><b>Payroll Period (Start Date)</b></td>
            <td>{{ $webhr_payroll_config[0]->payroll_period_start_date ?? '' }}</td>
          </tr>
          <tr>
            <td style="color:gray;"><b>Payroll Period (End Date)</b></td>
            <td>{{ $webhr_payroll_config[0]->payroll_period_end_date ?? '' }}</td>
          </tr>
          <tr>
