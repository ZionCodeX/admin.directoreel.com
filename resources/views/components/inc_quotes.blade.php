            ...
            <div class="col-md-10">
                ...
                <div class="d-flex justify-content-between pt-6">
                    <div class="d-flex flex-column flex-root">
                        ...
                        <span class="opacity-70">Jan 07, 2021</span>
                    </div>
                    <div class="d-flex flex-column flex-root">
                        <span class="font-weight-bolder mb-2">ORDER NO.</span>
                        <span class="opacity-70">73616-103</span>
                    </div>
                    <div class="d-flex flex-column flex-root">
                        <span class="font-weight-bolder mb-2"><b>DELIVERED TO</b></span>
                        <span class="opacity-70">Tochukwu Nkwocha, P.O. Box 283 8562 Ikeja.
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr class="font-weight-boldest">
                                <td class="border-0 pl-0 pt-7 d-flexx align-items-centerx">
                                White Chairs<br>
                                <small>Quality chairs made with white plastic materials</small>
                                </td>
                                <td class="text-right pt-7 align-middle">500</td>
                            ...
                            <tr class="font-weight-boldest border-bottom-0">
                                <td class="border-top-0 pl-0 py-4 d-flexx align-items-centerx">
                             
                                Green Plastic Chairs 750<br>
                                <small>These are all strong plastic chairs</small>
                                </td>
                            ...
                            <tr class="font-weight-boldest border-bottom-0">
                                ...
                                Chair Hooks<br>
                                <small>Quality chair hooks made of steel</small>
                                </td>
                                <td class="border-top-0 text-right py-4 align-middle">1,550</td>
            ...
            <div class="col-md-10">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="font-weight-bold text-muted text-uppercase text-right">TOTAL PAYABLE</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="font-weight-bolder">
                                <td class="text-primary font-size-h3 font-weight-boldest text-right">$1789.00</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
