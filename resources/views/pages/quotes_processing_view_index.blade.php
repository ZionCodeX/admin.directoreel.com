...
@section('title', 'Quotes Processing View')
    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <div class="card-header" style="">
          <div class="card-title">
            <h3 class="card-label">Processing Quotes
            <i class="mr-2"></i>
            <small class=""> | View Processing Quotes</small></h3>
          </div>
...
@foreach ( $quotes_show_processing as $record )
